<script>
  ...
  import { Iterator } from "../../utils/classes";
  ...
  console.log("value1: ", value1); // => { nextValue: 10, isDone: false }
  console.log("value2: ", value2); // => { nextValue: 20, isDone: false }
...
<section>
  <Page title="Iterator pattern" subTitle="(Open devtools)" />
</section>
